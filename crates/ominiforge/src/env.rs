//! Workspace development environments via direnv (`doc/design/runtime-architecture.md`).
//!
...
/// (`doc/design/runtime-architecture.md`). A missing/broken direnv or a blocked `.envrc` degrades to
